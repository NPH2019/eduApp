...
urlpatterns = [
    ...
    path('history/<int:client_id>', views.history, name='history'),
    path('login-client', views.login_client, name='login-client'),
    path('logout-client', views.logout_client, name='logout-client'),
    path('setting-client/<int:client_id>', views.setting_client, name='setting-client'),
